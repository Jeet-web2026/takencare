    ...
    return (
        <div className='bg-white'>
            <div className='min-w-[1300px] max-w-[1350px] mx-auto'>
                <section className='px-14 py-13 flex lg:flex-row flex-col items-center gap-12 relative'>
                    <Card className='absolute z-20 p-0 overflow-hidden ps-5 border-15 top-60 left-0 rounded-r-4xl flex flex-row bg-1 border-l-0 border-[#00bcdf]'>
