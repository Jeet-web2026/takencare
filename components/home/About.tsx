...
const About = () => {
    return (
        <section className='px-14 py-13 flex lg:flex-row flex-col items-center gap-8 bg-[#f2f9ff73]'>
            <div className="w-120">
                <Card className='border-none shadow-none flex justify-center bg-white items-center w-full py-0'>
