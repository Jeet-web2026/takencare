    ...
    return (
        <div className="bg-1">
            <div className='min-w-[1300px] max-w-[1350px] mx-auto'>
                <section className="px-14 flex pt-10 lg:flex-row flex-col items-center">
                    ...
                    <div className='w-2/3'>
                        ...
                        <h2 className='capitalize text-4xl font-bold text-white'>real patients, real stories</h2>
                        <h2 className='capitalize text-4xl font-bold text-white mb-5'>and our achivements.</h2>
