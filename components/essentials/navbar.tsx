...
export const Navbar = () => {
    ...
    return (
        <header className="fixed top-0 pe-10 ps-7 left-0 w-full shadow-md px-5 py-3 flex lg:flex-row flex-col justify-between items-center bg-white dark:bg-dark">
