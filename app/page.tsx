      ...
      <section className="flex flex-row justify-between px-[60px] pt-4 pb-[50px] relative items-center bg-[#E1EEFF]">
        ...
        <div className="absolute bg-[#017EFF] px-5 py-3 text-white -bottom-6 w-[91%] rounded-lg flex flex-row justify-between items-center">
          ...
          <div>
            ...
            <AlertDialog>
              <AlertDialogTrigger className="border rounded-[50%] border-white text-sm px-[8px] py-[5.5px] hover:bg-white hover:text-[#017EFF] text-sm transition delay-100 duration-200 ease-in-out"><i className="bi bi-search"></i></AlertDialogTrigger>
              <AlertDialogContent>
                <AlertDialogHeader>
